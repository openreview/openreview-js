...
describe.only('Abstract Extraction', function () {
  ...
  it('should return abstract and pdf using iospressComRule rule (iospress.com)',async function (){
    ...
    const pdfExpected = 'https://content.iospress.com:443/download/semantic-web/sw210428?id=semantic-web%2Fsw210428';
  ...
  it('should return pdf using iospressComRule rule (iospress.com)',async function (){
    ...
    const pdfExpected = 'https://content.iospress.com:443/download/journal-of-intelligent-and-fuzzy-systems/ifs219322?id=journal-of-intelligent-and-fuzzy-systems%2Fifs219322';
