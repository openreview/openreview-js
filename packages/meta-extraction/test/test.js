...
describe.only('Abstract Extraction', function () {
  ...
  it.skip('should extract abstract using arxiv rule', async function () {
    this.retries(3);
  ...
  it.skip('should return abstract and pdf using ieeeXploreOrgRule rule (ieeexplore.ieee.org)', async function () {
    this.retries(3);
  ...
  it('should return abstract and pdf using ePrintIacrRule rule (eprint.iacr.org)', async function () {
    // TODO: Re-enable when eprint.iacr.org responses are stable in CI (abstract sometimes returns undefined/mismatched content).
    this.skip();
  ...
  it.skip('should return abstract and pdf using mdpiComRule rule (www.mdpi.com)', async function () {
    this.retries(3);
